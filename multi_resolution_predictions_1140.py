...
Runs predictions at hourly, 30-minute, and 15-minute resolutions.
Generates overlay plots and hourly RMSE plots for each resolution.
...
def run_multi_resolution_predictions(data_path, config, output_dir, plant_name=None):
    """
    Run predictions at hourly, 30-minute, and 15-minute resolutions.
    Generate overlay plots and hourly RMSE plots for each.
    """
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description='Run multi-resolution predictions (hourly, 30-min, 15-min) for Project1140',
    ...
    print("\n" + "=" * 80)
    print("MODE: Multi-Resolution Predictions (Hourly, 30-minute, 15-minute)")
