...
if len(project1140_files) == 0:
    ...
    print(f"{'='*80}")
    print("\nGenerated files:")
    print("  - overlay_plot_hourly.png (all predictions overlay for hourly resolution)")
    print("  - overlay_plot_30_minute.png (all predictions overlay for 30-minute resolution)")
    print("  - overlay_plot_15_minute.png (all predictions overlay for 15-minute resolution)")
